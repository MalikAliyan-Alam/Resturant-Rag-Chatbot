...
# Normal text splitting (har 500 characters ka aik chunk)
...
for i, chunk in enumerate(chunks):
    # Cloud call (Generating vectors)
    vector = embeddings.embed_query(chunk)
    
    # ID ko unique rakhne ke liye hum "menu-chunk" use kar rahe hain taake purane data se clash na ho
